    ...
    <div class="container my-5">
        ...
        <?php if ($this->session->flashdata('success_update_profile')) : ?>
            <div class="alert alert-success" role="alert">
                <?= $this->session->flashdata('success_update_profile'); ?>
            </div>
        <?php endif; ?>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-12 user-profil-part pull-left">
                                <div class="row ">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12 user-detail-section1 text-center">
                                        ...
                                        <a href="<?= base_url() ?>workshops/new_workshop" class="btn btn-block" style="background-color:darkslategrey; color: white;">Buat Workshop</a></button>
                                                ...
                                                <div class="tab-content">
                                                    ...
                                                    <div role="tabpanel" class="tab-pane fade" id="buzz" style="margin-top: 20px;">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <p>******** <span><a href="<?= base_url(); ?>profile/change_password" data-target="#gantipass"><i class="fa fa-cog"> Ganti</a></i></span></p>
                                                            </div>
                                                        </div>
                                                    </div>
