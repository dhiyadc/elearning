  ...
  <!--Section: Block Content-->
   ...
   <div class="col-md-12">
      ...
      <ul style="list-style: outside none none;" class="nav nav-tabs" role="tablist">
          ...
          <li class="nav-item">
              <a class="nav-link active" data-toggle="tab" href="#tab1" role="tab" aria-expanded="true" style="font-size: 22px;">Daftar Siswa</a>
          </li>
                ...
                <div class="row bg-white has-shadow">
                  <div class="left-col col-lg-6 d-flex align-items-center justify-content-between">
                    <div class="project-title d-flex align-items-center">
                      ...
                      <div class="text">
                        <h3 class="h4" style="font-size: 20px;">Arya Pradata</h3><small>Siswa</small>
                      </div>
                    </div>
