...
<section>
  ...
  <div class="row">
    ...
    <div class="col-md-12 mb-4">
        ...
        <h5 class="text-center font-weight-bold mb-4" style="color: white">Quiz Kelas</h5>
...
<ul style="list-style: outside none none;" class="nav nav-tabs" role="tablist">
    ...
    <li class="nav-item">
        <a class="nav-link active" data-toggle="tab" href="#tab1" role="tab" aria-expanded="true" style="font-size: 22px;">Quiz Siswa</a>
    </li>
    ...
    <div class="row bg-white has-shadow">
      <div class="left-col col-lg-6 d-flex align-items-center justify-content-between">
        <div class="project-title d-flex align-items-center">
          <div class="image has-shadow"><img src="<?php echo base_url(); ?>assets/images/task.png" alt="..." class="img-fluid rounded-circle"></div>
          <div class="text">
            <a href=""data-toggle="modal" data-target="#elegantModalForm1"><h3 class="h4" style="font-size: 20px;">Quiz 1</h3><small>PTI</small></a>
          </div>
        </div>
        <!-- <div class="project-date"><span class="hidden-sm-down">Hari Ini pada 4:24 AM</span></div> -->
      </div>
