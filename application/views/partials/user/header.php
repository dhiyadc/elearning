          ...
          <div class="ml-auto w-20">
            <nav class="site-navigation position-relative text-right" role="navigation">
                              ...
                              <li class="notification-box">
                                <div class="row">
                                  ...
                                  <div class="col-md-8" style="text-shadow: 0px 0px white;">
                                    ...
                                    <div>
                                      <a href="<?= base_url('class/') ?><?= $val2['id_workshop'] ?>/<?= $val2['id_kegiatan']; ?>" id="sess<?= $val2['id_workshop'] ?>><b>Workshop</b> " <?= $val2['judul_workshop']; ?>" Sedang Dimulai</a> </div> <small class="text-warning"><?= $val2['tanggal']; ?></small>
                                        <br>
                      ...
                      <li class="notification-box">
                        <div class="row">
                          ...
                          <div class="col-md-8" style="text-shadow: 0px 0px white;">
                            <strong class="text-info"><?= $val2['nama']; ?></strong>
                            <div>
                              <a href="<?= base_url('class/') ?><?= $val2['id_kelas'] ?>/<?= $val2['id_kegiatan']; ?>" id="sessc<?= $val2['id_kelas'] ?>"><b>Kelas</b> "<?= $val2['judul_kelas']; ?>" Sedang Dimulai</a>
                            </div>
              ...
              <li class="footer text-center" style="background-color: forestgreen;">
                ...
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink-333" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Hi, <?= $nama[0]; ?> <i class="fa fa-user"></i>
                  </a>
