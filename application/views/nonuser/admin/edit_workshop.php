<?php $this->load->view('nonuser/admin/header'); ?>
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Edit Workshop</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <form enctype="multipart/form-data" action="<?= base_url()?>admin/edit_workshop_action/<?= $val['id_workshop']; ?>" method="post" role="form">
                                                <div class="form-group">
                                                    <label>Judul</label>
                                                    <input type="text" name="judul" value="<?= $val['judul_workshop']; ?>" required class="form-control">
                                                </div>
                                                <div class="form-group">
                                                    <label>Deskripsi</label>
                                                    <textarea name="deskripsi" required class="form-control ckeditor" rows="3" id=ckeditor><?= $val['deskripsi_workshop']; ?></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label>Poster</label>
