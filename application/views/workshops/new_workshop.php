...
<div class="container">
    <form enctype="multipart/form-data" action="<?= base_url() ?>workshops/new_class_action" method="post" class="form-horizontal">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        ...
                        <input type="text" name="judul" class="form-control" id="nameclass" placeholder="" required autofocus>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
        ...
        <div class="row">
            <div class="col-md-3 field-label-responsive">
                <label for="newpassword1">Tipe Workshop</label>
            </div>
            <div class="col-md-8">
        ...
        <div id="showHideHarga" style="display: none">
            <div class="row">
                <div class="col-md-3 field-label-responsive">
                    <label for="password">Harga Workshop</label>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="input-group mb-2 mr-sm-2 mb-sm-0">
        ...
        <div class="row">
            <div class="col-md-3 field-label-responsive">
                <label for="password">Jadwal Workshop</label>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        <div id="kegiatan_field">
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="deskripsi_kegiatan" placeholder="Deskripsi Singkat..." required></textarea>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group date form_datetime " data-date-format="yyyy/mm/dd hh:ii" data-link-field="dtp_input1">
                                        <input class="form-control" id="inputdatetimepicker" size="16" type="text" name="tanggal_kegiatan" readonly required>
